...
class ClassMethod(ClassFeature):
    def __init__(self, name, formal_params, return_type, body,class_name = None):
...
class ClassAttribute(ClassFeature):
    def __init__(self, name, attr_type, init_expr,class_name = None):
...
class Let(Expr):
    ...
    def to_readable(self):
        return "\n{}(variables={}, body={})".format(self.clsname, self.variables, self.body)
